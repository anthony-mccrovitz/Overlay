...
def main():
    parser = argparse.ArgumentParser(description="ChefTonyBets morning run")
    ...
    print(f"\n{'='*60}")
    print(f"  ChefTonyBets Morning Run — {args.sport.upper()} — {date.today().strftime('%B %d, %Y')}")
    print(f"{'='*60}\n")
